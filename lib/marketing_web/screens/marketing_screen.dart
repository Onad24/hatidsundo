...
class _MarketingScreenState extends State<MarketingScreen> {
  ...
  Future<void> _downloadApk() async {
    final Uri url = Uri.parse(
      'https://dwogrvalyrbubwsaunyo.supabase.co/storage/v1/object/public/apk/HatidSundo-release.apk',
    );
              ...
              return GridView.count(
                ...
                children: [
                  ...
                  _FeatureCard(
                    ...
                    title: 'In-Trip Chat',
                    description: 'Communicate directly with your driver through built-in messaging.',
                  ),
                  _FeatureCard(
                    icon: Icons.attach_money,
                    title: 'Transparent Pricing',
                    description: 'See the estimated fare before you book. No hidden charges.',
                  ),
                  _FeatureCard(
                    icon: Icons.verified_user_outlined,
                    title: 'Verified Drivers',
                    description: 'Travel with confidence knowing your driver is vetted.',
                  ),
                  _FeatureCard(
                    icon: Icons.history,
                    title: 'Trip History',
                    description: 'Access your complete ride history with detailed route summaries.',
                  ),
                  _FeatureCard(
                    icon: Icons.dashboard_outlined,
                    title: 'Admin Dashboard',
                    description: 'Operators get a full web dashboard to manage the platform.',
                  ),
                ],
              );
            }
      ...
      child: Column(
        children: [
          ...
          Wrap(
            ...
            children: [
              _StepCard(number: '01', title: 'Set Destination', desc: 'Open the app and enter where you want to go.'),
              _StepCard(number: '02', title: 'Get Matched', desc: 'A nearby verified driver accepts your request.'),
              _StepCard(number: '03', title: 'Enjoy Ride', desc: 'Track your trip in real time and arrive safely.'),
            ],
          )
        ],
      ),
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            label: const Column(
              ...
              children: [
                Text('Download for', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(description, style: const TextStyle(fontSize: 15, color: Colors.white60)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(desc, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, color: Colors.white60)),
        ],
      ),
    );
  }
